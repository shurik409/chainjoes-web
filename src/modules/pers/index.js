        ...
        <Box sx={{ backgroundColor: "#000000" }}>
          ...
          >
            <Box
              sx={{
                display: "flex",
                width: `${header.length * 237}px`,
                // marginLeft: `calc(30px + max(calc(${
                //   header.length * 237 + 30
                // }px - 100vw), 0px) * -${curentProgress})`,
                marginLeft: `calc(min(${
                  curentItem > 1 ? 237 * curentItem - 237 : -30
                }px, calc(${header.length * 237 + 30}px - 100vw)) * -1)`,
              }}
            >
              {header.map((item, index) => (
                <Box
            ...
            >
              <Box
                sx={{
                  ...
                  backgroundColor: "#44F4C3",
                  marginLeft: `${
                    curentProgress * (header.length * 237 - 237)
                  }px`,
                }}
              ></Box>
            </Box>
